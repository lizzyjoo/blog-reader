    ...
    <>
      ...
      <div className="top">
        ...
        <div className="bird">
          ...
          <p className="quail-cite">
            cute quail by{" "}
            <a
              href="https://uiverse.io/AatreyuShau/lazy-quail-10"
              target="_blank"
        ...
        <div className="about-creator">
          <div className="hello">Hi, my name is Lizzy and I'm a...</div>
          <div className="my-info-rows">
            <div>
              {" "}
              <span>Full-stack developer</span>{" "}
              <p>I build web apps and occasionally convince them to work</p>
            </div>
            <div>
              <span>Violinist</span> Chamber music enthusiast, particularly
              those of Brahms, Ravel, and Schubert{" "}
              <span id="violin-link">
                <a href="">^here </a> is proof
              </span>
            </div>
            <div>
              {" "}
              <span>Neuroscience grad student</span>(on paper) but I'm working
              my way out to be a software engineer...
            </div>
          </div>
        </div>
      </div>
      <div className="bottom">
        <div className="about-urtext">
          <h2>What's URTEXT?</h2>
          <p>
            URTEXT started as a learning project, but I'm building it into
            something I actually want to use: a blog platform for classical
            musicians.
          </p>
          ...
          <div className="features-section">
            <h3>What's coming:</h3>
            <p>
              Music notation support (because writing about Brahms would be
              better without having to take screenshots).
            </p>
            <p>Audio/video embeds for performance clips.</p>
            <p>Admin Dashboard</p>
          </div>

          <p className="urtext-name">
            The name? <em>Urtext</em> means "the original, unedited version of a
            musical score." I want people (and myself) to be able to share
            original ideas (even if rough!) and enrich one another :)
          </p>
        </div>
      </div>
    </>
